...
def csv_to_numpy():
    ...
    data = pd.read_csv("/Your-VAME-Project/videos/pose-estimation/video-1-PE.csv", skiprows = 2)
    ...
    np.save("/Your-VAME-Project/data/video-1/video-1-PE-seq.npy", final_positions)
